# 此项目只是在[lovebing项目上扩展实现的](https://github.com/lovebing/react-native-baidu-map)，感谢lovebing!添加了一个骑行路线规划的功能,去除了marker点击显示的功能，暂不支持ios；
...
![Android路线规划](https://raw.githubusercontent.com/lovebing/react-native-baidu-map/master/images/ic_route_plan.jpg)
